...
function AdminCategoriesPage() {
    ...
    async function handleToggle(category) {
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateCategory"])({
                id: category.id,
    ...
    async function handleCreate() {
        ...
        setSaving(true);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createCategory"])(newName.trim());
            setCategories((prev)=>[
                    result.category,
                    ...prev
                ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9834413f._.js.map