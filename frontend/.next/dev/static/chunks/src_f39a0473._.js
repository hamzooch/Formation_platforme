...
function StudentCoursesPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StudentCoursesPage.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiGet"])("/courses").then({
                "StudentCoursesPage.useEffect": (payload)=>setCourses(payload)
            }["StudentCoursesPage.useEffect"]).catch({
                "StudentCoursesPage.useEffect": ()=>setCourses([])
            }["StudentCoursesPage.useEffect"]);
        }
    }["StudentCoursesPage.useEffect"], []);
    async function handleEnroll(courseId) {
        ...
        setBusyId(courseId);
        try {
            const response = await fetch(`${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiBase"])()}/courses/${courseId}/enroll`, {
                method: "POST",
                headers: {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "text-xs text-muted",
                                                children: enrollments[course.id] === "PENDING" ? "En attente" : enrollments[course.id] === "APPROVED" ? "Inscrit" : enrollments[course.id] === "REJECTED" ? "Refuse" : ""
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/student/courses/page.tsx",
                                                lineNumber: 75,
                                                columnNumber: 21
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                children: busyId === course.id ? "..." : enrollments[course.id] === "PENDING" ? "Demande envoyee" : "S'inscrire"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/student/courses/page.tsx",
                                                lineNumber: 84,
                                                columnNumber: 21
...
_s(StudentCoursesPage, "VM9G4552CXZl/hozOwLUk92zirM=");
...
//# sourceMappingURL=src_f39a0473._.js.map