...
function AdminUsersPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminUsersPage.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchUsers"])({
                ...
                page,
                pageSize: 10
            }).then(setPayload).catch({
                "AdminUsersPage.useEffect": ()=>setPayload(null)
            }["AdminUsersPage.useEffect"]);
        }
    }["AdminUsersPage.useEffect"], [
        search,
    ...
    const summary = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminUsersPage.useMemo[summary]": ()=>{
            return {
                total: payload?.total ?? 0,
                pending: users.filter({
                    "AdminUsersPage.useMemo[summary]": (user)=>user.status === "PENDING"
                }["AdminUsersPage.useMemo[summary]"]).length,
                blocked: users.filter({
                    "AdminUsersPage.useMemo[summary]": (user)=>user.status === "BLOCKED"
                }["AdminUsersPage.useMemo[summary]"]).length
            };
        }
    }["AdminUsersPage.useMemo[summary]"], [
    ...
    async function handleStatus(user) {
        ...
        setBusyId(user.id);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateUserStatus"])(user.id, action);
            setPayload((prev)=>{
                if (!prev) return prev;
                return {
                    ...prev,
...
_s(AdminUsersPage, "lWW0V898vJggw6gAJPctA1xe+D8=");
_c = AdminUsersPage;
var _c;
...
//# sourceMappingURL=src_740e73fb._.js.map