...
function TrainerCourseManagePage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TrainerCourseManagePage.useEffect": ()=>{
            if (!courseId) return;
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiGet"])(`/courses/${courseId}`).then({
                "TrainerCourseManagePage.useEffect": (payload)=>setCourse(payload)
            }["TrainerCourseManagePage.useEffect"]).catch({
                "TrainerCourseManagePage.useEffect": ()=>setCourse(null)
            }["TrainerCourseManagePage.useEffect"]);
        }
    }["TrainerCourseManagePage.useEffect"], [
        courseId
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TrainerCourseManagePage.useEffect": ()=>{
            if (!courseId) return;
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiGet"])(`/courses/${courseId}/modules`).then({
                "TrainerCourseManagePage.useEffect": (payload)=>setModules(payload)
            }["TrainerCourseManagePage.useEffect"]).catch({
                "TrainerCourseManagePage.useEffect": ()=>setModules([])
            }["TrainerCourseManagePage.useEffect"]);
        }
    }["TrainerCourseManagePage.useEffect"], [
        courseId
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TrainerCourseManagePage.useEffect": ()=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiGet"])(`/modules/${selectedModuleId}/lessons`).then({
                "TrainerCourseManagePage.useEffect": (payload)=>setLessons(payload)
            }["TrainerCourseManagePage.useEffect"]).catch({
                "TrainerCourseManagePage.useEffect": ()=>setLessons([])
            }["TrainerCourseManagePage.useEffect"]);
        }
    }["TrainerCourseManagePage.useEffect"], [
        selectedModuleId
    ...
    async function handleCreateModule(event) {
        ...
        if (response.ok) {
            setModuleTitle("");
            const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiGet"])(`/courses/${courseId}/modules`);
            setModules(updated);
    ...
    async function handleCreateLesson(event) {
        ...
        setMessage("");
        const response = await fetch(`${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiBase"])()}/modules/${selectedModuleId}/lessons`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
_s(TrainerCourseManagePage, "p5ml854B0CWt5dxvJ6AyjKcVM3U=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"]
    ];
});
_c = TrainerCourseManagePage;
var _c;
__turbopack_context__.k.register(_c, "TrainerCourseManagePage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_35129af9._.js.map